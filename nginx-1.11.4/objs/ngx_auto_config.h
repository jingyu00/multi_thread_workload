#define NGX_CONFIGURE " --error-log-path=logs/error.log --conf-path=logs/nginx.conf --without-http_rewrite_module"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 5.3.1 20160225 (Ubuntu/Linaro 5.3.1-10ubuntu2) "
#endif
...
#define NGX_CONF_PATH  "logs/nginx.conf"
#endif
